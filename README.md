...
5 | There are 3 products with both negative current stock amounts and negative pricing. Neither should be allowed. | <ul><li>The current stock of these products has been set to 0. </li><li>Pricing has been set to the absolute value as this fits into same vicinity of other products with the same name/details. (This needs to be validated) </li><li>A stg_products_data_issues table has been created to list these issues for further analysis and debugging. </li></ul>
